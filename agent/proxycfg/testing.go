...
func TestConfigSnapshotIngressDiscoveryChain(t testing.T) *ConfigSnapshot {
	return testConfigSnapshotIngressGateway(t, true, "simple")
}

func TestConfigSnapshotIngressDiscoveryChainWithOverrides(t testing.T) *ConfigSnapshot {
	return testConfigSnapshotIngressGateway(t, true, "simple-with-overrides")
}
func TestConfigSnapshotIngressDiscoveryChain_SplitterWithResolverRedirectMultiDC(t testing.T) *ConfigSnapshot {
	return testConfigSnapshotIngressGateway(t, true, "splitter-with-resolver-redirect-multidc")
}

func TestConfigSnapshotIngressDiscoveryChainExternalSNI(t testing.T) *ConfigSnapshot {
	return testConfigSnapshotIngressGateway(t, true, "external-sni")
}

func TestConfigSnapshotIngressDiscoveryChainWithSplitter(t testing.T) *ConfigSnapshot {
	return testConfigSnapshotIngressGateway(t, true, "chain-and-splitter")
}

func TestConfigSnapshotIngressDiscoveryChainWithGRPCRouter(t testing.T) *ConfigSnapshot {
	return testConfigSnapshotIngressGateway(t, true, "grpc-router")
}

func TestConfigSnapshotIngressDiscoveryChainWithRouter(t testing.T) *ConfigSnapshot {
